...
public class WxQcqrActivity extends BaseActivity implements CommBaseView {
    private static final String Title = "维修QC确认";
...
//    EditText zcSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wxqr_qc);
        this.setTitle(Title);
